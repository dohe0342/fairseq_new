...
from transformers import GPT2Tokenizer, GPT2Model, BertTokenizer, BertModel, AutoTokenizer, MistralModel
from fairseq.data.data_utils import post_process
...
class Clip3Criterion(FairseqCriterion):
    def __init__(
        ...
        if self.decoder_type == 'conv':
            ...
            embed_dim = 4096
            if d != embed_dim:
                self.lm_decoder.append(Linear(d, embed_dim, bias=False))
