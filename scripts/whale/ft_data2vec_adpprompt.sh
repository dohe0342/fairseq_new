...
fairseq-hydra-train \
	...
	common.tensorboard_logdir=/home/work/workspace/fairseq/scripts/whale/outputs/$1_dim \
	common.log_file=/home/work/workspace/fairseq/scripts/whale/outputs/$1_dim.log \
	task.data=/home/work/workspace/LibriSpeech/manifests \
	task.normalize=true \
	model.w2v_path=/home/work/workspace/models/data2vec_model/audio_base_ls.pt \
	checkpoint.save_dir=/home/work/workspace/fairseq/scripts/whale/outputs/$1_dim \
